...
cls
echo.
echo Amazon Launcher ausschalten
echo.
...
echo adb shell "pm disable-user --user 0 com.amazon.tv.forcedotaupdater.v2"
echo adb shell "pm disable-user --user 0 com.amazon.device.software.ota"
echo adb shell "pm disable-user --user 0 com.amazon.device.software.ota.override"
